...
builder.Services.AddSingleton<ITaskCompletionPointsCalculator, CategoryWeightedTaskCompletionPointsCalculator>();
builder.Services.AddScoped<ITaskCompletionRewardService, TaskCompletionRewardService>();
builder.Services.AddSingleton<IReviewQualityBonusCalculator, ReviewQualityBonusCalculator>();
builder.Services.AddScoped<ITaskReviewBonusService, TaskReviewBonusService>();
