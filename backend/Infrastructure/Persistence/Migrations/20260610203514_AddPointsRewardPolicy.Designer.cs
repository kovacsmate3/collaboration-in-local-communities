...
namespace Backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260610203514_AddPointsRewardPolicy")]
    partial class AddPointsRewardPolicy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Category", b =>
                {
                    ...
                    b.Property<string>("Icon")
                        ...
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasDefaultValue("MoreHorizontalCircle01Icon")
                        .HasColumnName("icon");
                    ...
                    b.ToTable("categories", "config", t =>
                        {
                            t.HasCheckConstraint("ck_categories_points_weight_positive", "points_weight > 0");
                        });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.PointsLedgerEntry", b =>
                {
                    ...
                    b.HasIndex(new[] { "TaskId", "ProfileId", "EntryType" }, "ux_points_ledger_task_review_bonus_once")
                        .IsUnique()
                        .HasDatabaseName("ux_points_ledger_task_review_bonus_once")
                        .HasFilter("entry_type = 'ReviewQualityBonus'");

                    b.HasIndex(new[] { "TaskId", "ProfileId", "EntryType" }, "ux_points_ledger_task_reward_once")
                        .IsUnique()
                    ...
                    b.ToTable("points_ledger", "data", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_points_ledger_entry_type", "entry_type IN ('TaskCompletedReward', 'ReviewQualityBonus', 'ManualAdjustment', 'Redemption')");
                        });
                });
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Skill", b =>
                {
                    ...
                    b.ToTable("skills", "config", t =>
                        {
                            t.HasCheckConstraint("ck_skills_status", "status IN ('Pending', 'Approved')");
                        });
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Backend.Infrastructure.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ba1e8ed9-809e-4a1a-a4b8-e3a80c87cf8f"),
                            ConcurrencyStamp = "ba1e8ed9-809e-4a1a-a4b8-e3a80c87cf8f",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("da637a4d-0e15-4e7d-977a-b978362e20bb"),
                            ConcurrencyStamp = "da637a4d-0e15-4e7d-977a-b978362e20bb",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
